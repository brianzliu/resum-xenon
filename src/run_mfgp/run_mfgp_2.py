...
noise = {"lf": LF_cnp_noise, "hf": HF_sim_noise *0.0001} # 0.001 # 0.0001
...
if hasattr(gpy_linear_mf_model.mixed_noise.Gaussian_noise, 'unfix'):
    ...
    gpy_linear_mf_model.mixed_noise.Gaussian_noise_1.constrain_bounded(
        noise['hf'] * 0.99, noise['hf'] * 1.01) # 0.99, 1.01; 0.20, 1.80
...
current_file_results = analyzer.run_complete_analysis(
    file_patterns=["../xenon/out/cnp/cnp_v101.0_output_validation_15epochs.csv"],  # The file we used for training
    validation_cnp_file='../xenon/out/cnp/cnp_v101.0_output_validation_15epochs.csv',
    hf_validation_dir='/home/tidmad/bliu/resum-xenon/src/xenon/in/data/new_both/validation/hf',
